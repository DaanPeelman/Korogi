package com.korogi.rest.restservice.episode;
...
class ConsultEpisodeDetailsServiceTest extends BaseServiceTest {
     ...
     */
    @Test
    @DatabaseSetup("/com/korogi/rest/restservice/episode/ConsultEpisodeDetailsServiceTest_consultEpisodeDetails.xml")
    void consultEpisodeDetails() throws Exception {
        performAndPrint(get(URL, 1))
            .andExpect(status().isOk())
            .andExpect(json().matchesFileContent("com/korogi/rest/restservice/episode/ConsultEpisodeDetailsServiceTest_consultEpisodeDetails_expected.json"));
