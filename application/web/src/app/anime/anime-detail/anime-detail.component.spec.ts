...
describe('AnimeDetailComponent', () => {
    ...
    describe("ngOnInit", () => {
        it("should call the AnimeService to load the Anime with the identifier retrieved from the path and set all the fields on the component", fakeAsync(() => {
            ...
            embedded[BaseAnimeRelation.EPISODES] = [EpisodeTestData.steinsGate_episode1(), EpisodeTestData.steinsGate_episode2()];
            embedded[BaseAnimeRelation.PERSONAGES] = [PersonageTestData.okabeRintarou(), PersonageTestData.makiseKurisu()];
