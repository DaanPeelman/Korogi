...
describe('DateUtil', () => {
    ...
    describe("parse", () => {
       it("should return a date with year, month, day, hour, minute and second values corresponding to the passed ISO formatted datestring", () => {
           let expectedDate: Date = new Date(2019, 0, 10, 9, 35, 20); // month is zero based

           expect(DateUtil.parse("2019-01-10T09:35:20")).toEqual(expectedDate);
       });

       it("should return a date with year, month and day values corresponding to the passed ISO formatted datestring at midnight", () => {
          let expectedDate: Date = new Date(2019, 0, 10, 0, 0, 0);
