...
export class AnimeTestData {
  static steinsGate(): Anime {
    return new Anime(
      ...
      'https://localhost:8443/assets/images/backdrop.steins.gate.jpg',
      'https://localhost:8443/assets/images/poster.steins.gate.jpg'
    );
  }

  static steinsGateEgoisticPoriomania(): Anime {
    return new Anime(
      ...
      'https://localhost:8443/assets/images/backdrop.steins.gate.egoistic.poriomania.jpg',
      'https://localhost:8443/assets/images/poster.steins.gate.egoistic.poriomania.jpg'
    );
  }
  ...
  static naruto(): Anime {
    return new Anime(
      ...
      "https://localhost:8443/assets/images/backdrop.naruto.jpg",
      "https://localhost:8443/assets/images/poster.naruto.jpg"
    );
  }
}
