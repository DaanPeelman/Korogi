...
export class AnimeTestData {
    static steinsGate(): AnimeDTO {
        ...
        animeDTO.startAir = '2011-04-06';
        animeDTO.endAir = '2011-09-14';
    ...
    static steinsGateEgoisticPoriomania(): AnimeDTO {
        ...
        animeDTO.startAir = "2012-02-22";
        animeDTO.endAir = "2012-02-22";
    ...
    static naruto(): AnimeDTO {
        ...
        animeDTO.startAir = "2002-10-03";
        animeDTO.endAir = "2007-02-08";
