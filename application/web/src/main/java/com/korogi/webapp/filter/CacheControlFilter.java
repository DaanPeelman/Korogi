...
public class CacheControlFilter implements Filter {
    ...
    private static final CacheableResourcePatternUtil CACHEABLE_RESOURCE_PATTERN_UTIL = new CacheableResourcePatternUtil();
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (CACHEABLE_RESOURCE_PATTERN_UTIL.isCacheableResource(requestUri)) {
